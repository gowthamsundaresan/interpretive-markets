...
import { loadDeployment, readFrameworkUri, readMarket, signAndPostVerdict } from '../services/chain'
...
export async function startResolveWorker(args: { queue: JobQueue; config: IEnvSchema; logger: WorkerLogger }) {
...
async function runJob(job: Job, queue: JobQueue, config: IEnvSchema, logger: WorkerLogger) {
