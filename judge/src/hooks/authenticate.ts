...
export function authenticateHook(server: FastifyInstance, _opts: FastifyPluginOptions, next: () => void) {
...
declare module 'fastify' {
    interface FastifyInstance {
        apiKeyAuth: (request: import('fastify').FastifyRequest, reply: import('fastify').FastifyReply) => Promise<void>
    }
}
